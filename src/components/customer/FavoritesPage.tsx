...
const FavoritesPage = () => {
  ...
  const favoriteServices: ServiceListItem[] = favorites.map(fav => {
    ...
    // Map service data to ServiceListItem with proper type conversions
    return {
      id: fav.service.id,
      title: fav.service.title,
      description: fav.service.description || '',
      category: fav.service.category || 'other',
      pricingModel: fav.service.pricingModel || 'fixed',
      price: fav.service.price,
      providerName: fav.service.provider_name || '',
