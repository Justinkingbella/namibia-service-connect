...
// Mock data for provider's transactions
...
const mockWalletTransactions: WalletTransaction[] = [
  ...
  },
  {
    id: 'wtrans3',
    walletType: 'e_wallet',
    referenceNumber: 'EW456789123',
    amount: 150.00,
    senderPhone: '0845678901',
    receiverPhone: '0823456789',
    status: 'pending',
    transactionDate: new Date('2023-05-13T09:15:00'),
    description: 'Payment for Booking #booking9876543',
...
const ProviderTransactionsPage = () => {
  ...
  const { data: bookingTransactions, isLoading: loadingBookingTransactions } = useQuery({
    queryKey: ['providerBookingTransactions'],
    queryFn: async () => {
      // Simulate API call
  ...
  const { data: walletTransactions, isLoading: loadingWalletTransactions } = useQuery({
    queryKey: ['providerWalletTransactions'],
    queryFn: async () => {
      // Simulate API call
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mt-1">N$630.00</h3>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mt-1">N$70.00</h3>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mt-1">N$560.00</h3>
                </div>
                      ...
                      <tbody>
                        {filteredBookingTransactions.map((transaction) => (
                          <tr key={transaction.id} className="border-b hover:bg-muted/50">
                            ...
                            <td className="py-3 px-4">N${transaction.amount.toFixed(2)}</td>
                            <td className="py-3 px-4 text-red-600">-N${transaction.fee.toFixed(2)}</td>
                            <td className="py-3 px-4 font-medium">N${transaction.net.toFixed(2)}</td>
                      ...
                      <tbody>
                        {filteredWalletTransactions.map((transaction) => (
                          <tr key={transaction.id} className="border-b hover:bg-muted/50">
                            ...
                            <td className="py-3 px-4">{transaction.senderPhone}</td>
